package com.tito97.pacman.entities 
{
	...
	/**
	 * This class extends Sprite because its instances will be assigned the ghosts' graphics.
	 * @author Diogo
	 */
	public class GhostGraphics extends Sprite 
	{
		...
		/**
		 * Constructs a Sprite for the Ghosts' graphics.
		 * @param	color The color for the Ghost's body and eye
		 * @param	direction The initial direction in which the eyes are looking at
		 */
		...
		/**
		 * Changes the direction in which the eyes are looking at.
		 * @param	direction The new direction for the eyes to look at
		 */
		...
		{
			// Removes all Shapes from this Sprite (if there are any)
		...
		/**
		 * Atualiza a animação do andamento do fantasma
		 */
